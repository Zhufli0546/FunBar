    ...
    <div class="row" style="float: left">
      ...
      <div class="col-lg-3">
        ...
        <div class="list-group" style="width:100px">
          <a href="addActivity" class="list-group-item">Category </a>
  ...
  <div class="row">
    ...
    <div class="col-lg-4 col-sm-6 mb-4">
      <div class="card h-100">
        ...
        <img class="card-img-top" src="<c:url value='/getPicture/${activity.activityId }'/>"></a>
        <div class="card-body">
          <h4 class="card-title">
            <a href="<spring:url value='/activity?id=${activity.activityId}' />">${activity.eventName}</a>
          </h4>
