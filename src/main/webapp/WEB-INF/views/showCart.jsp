...
<body>
	...
	<div class="page row">
			...
			<div class="col-md-8">
		<div align="right" colspan="8" style="float:fight;margin:10px 10px 0px 0px">
			...
			<table class="table" style="margin: 20px 0">
				...
				<tbody>
					<c:forEach var="ci" items="${sessionScope.Cart.cartItems}"
						...
						<tr>
							<td><div style="text-align:center"><img
							...
							<td><div style="float:right"><input type="hidden" class="price"
								value="${ci.subtotal}"> <a class="removeBtn"
								href=" <c:url value='/removeCartItem?productId=${ci.product.productId}' />">刪除</a></div>
							</td>
	...
	<div class="modal fade" id="createForm" role="dialog"
		aria-labelledby="myModalLabel1" style="background: rgba(0, 0, 0, 0.8)">
